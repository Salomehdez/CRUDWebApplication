...
import com.laura.dao.StudentDao;
import com.laura.dao.StudentDaoLocal;
import com.laura.model.Student;
import static com.laura.model.Student_.yearLevel;
...
public class StudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String action = request.getParameter("ation");
        ...
        String yearLevelStr = request.getParameter("yearLevelStr");
        int yerarLevel=0;
